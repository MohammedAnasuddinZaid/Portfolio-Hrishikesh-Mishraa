...
export const Footer: React.FC<FooterProps> = ({ onOpenContact }) => {
  ...
  return (
    <footer id="contact" className="py-16 bg-[#141414] text-[#f5f5f5] border-t border-black relative premium-noise">
        ...
        <div className="grid md:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          <div className="md:col-span-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[10px] uppercase tracking-widest font-black text-[#f5f5f5]/70">Available for Strategic Advisory & Angel Investment</span>
            </div>
          </div>
          <div className="md:col-span-3">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-red-500 mb-6">Navigation</h4>
          ...
          <div className="md:col-span-4">
            <h4 className="text-[10px] font-black uppercase tracking-widest text-red-500 mb-6">Direct Channels</h4>
            <div className="space-y-4 text-xs text-[#f5f5f5]/80">
              <div>
                ...
                <a href={`mailto:${PORTFOLIO_INFO.email}`} className="text-white font-bold text-sm hover:text-red-500 transition-colors">{PORTFOLIO_INFO.email}</a>
              </div>
              <div>
              ...
              <div className="pt-2">
                <button onClick={onOpenContact} className="w-full py-3 bg-red-600 text-white font-black text-xs uppercase tracking-widest hover:bg-red-700 transition-all shadow-md">Schedule A Meeting</button>
              </div>
            </div>
          </div>
        </div>
